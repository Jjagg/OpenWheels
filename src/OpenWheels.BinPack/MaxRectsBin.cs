...
namespace OpenWheels.BinPack
{
    ...
    public class MaxRectsBin
    {
        ...
        public Rectangle[] Insert(Size[] sizes, MaxRectsHeuristic heuristic = MaxRectsHeuristic.Bssf)
        {
            if (sizes == null)
        ...
        /// </exception>
        public void Insert(Size[] sizes, Rectangle[] bounds, int indexOffset = 0, MaxRectsHeuristic heuristic = MaxRectsHeuristic.Bssf)
        {
            if (sizes == null)
                throw new ArgumentNullException(nameof(sizes));
            if (bounds == null)
        ...
        private int GetBestRect(Size[] sizes, MaxRectsHeuristic heuristic, List<int> indices, out Rectangle bestNode)
        {
            ...
            for (var indirectIndex = 0; indirectIndex < indices.Count; indirectIndex++)
            {
                ...
                var score1 = 0;
                var score2 = 0;
                var newNode = ScoreRect(sizes[i].Width + PaddingWidth * 2, sizes[i].Height + PaddingHeight * 2, heuristic,
                    ref score1,
                    ref score2);
